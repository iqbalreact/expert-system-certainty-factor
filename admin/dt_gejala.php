                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Data Gejala <a href="tb_gejala.php"><button type="button" class="btn btn-success btn-sm"><i class="fa fa-plus"></i>&nbsp; Tambah Gejala</button></a></strong></strong>
                        </div>
                        <div class="card-body">
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    ?>
                      ...
                      <tr>
                        <td><?php echo $no; ?></td>
                        <td><?php echo $dt ['kd_gejala']; ?></td>
                        <td><?php echo $dt ['gejala']; ?></td>
                        <td>
                            <a href="edit_gejala.php?kd_gejala=<?php echo $dt['kd_gejala'] ; ?>">
                            <button type="button" class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o"></i>&nbsp; Edit</button></a>


                            <a href="php/delete_gejala.php?kd_gejala=<?php echo $dt['kd_gejala'] ; ?>" Onclick="return confirm('Yakin Ingin Menghapus?')">
