                  ...
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    <tbody>
                       ...
                       <?php
                        ...
                        // $query = "SELECT * FROM `hasil` INNER JOIN pasien ON hasil.id_pasien = pasien.id_pasien INNER JOIN penyakit ON hasil.kd_penyakit = penyakit.kd_penyakit";
                        $query = "SELECT * FROM `pasien` INNER JOIN penyakit ON pasien.kd_penyakit = penyakit.kd_penyakit";
                    ...
                    ?>
                      ...
                      <tr>
                        <td><?php echo $no; ?></td>
                        <td><?php echo $dt ['nm_pasien']; ?></td>
                        <td><?php echo $dt ['umur']; ?></td>
                        <td><?php echo $dt ['jenis_kl']; ?></td>
                        <td><?php echo $dt ['nm_penyakit']; ?></td>
                        <td><?php echo $dt ['nilaicf']; ?> %</td>
                        <td>
                            <a href="php/delete_pasien.php?id_pasien=<?php echo $dt['id_pasien']; ?>&kd_penyakit=<?php echo $dt['kd_penyakit']; ?>" Onclick="return confirm('Yakin Ingin Menghapus?')">
