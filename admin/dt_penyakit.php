                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Data Penyakit <a href="tb_penyakit.php"><button type="button" class="btn btn-success btn-sm"><i class="fa fa-plus"></i>&nbsp; Tambah Penyakit</button></a></strong>
                        </div>
                        <div class="card-body">
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    ?>
                      ...
                      <tr>
                        <td><?php echo $no; ?></td>
                        <td><?php echo $dt ['kd_penyakit']; ?></td>
                        <td><?php echo $dt ['nm_penyakit']; ?></td>
                        <td>
                            <a href="edit_penyakit.php?kd_penyakit=<?php echo $dt['kd_penyakit'] ; ?>">
                            <button type="button" class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o"></i>&nbsp; Edit</button></a>

                             <a href="php/delete_penyakit.php?kd_penyakit=<?php echo $dt['kd_penyakit']; ?>">
                            <button type="button" class="btn btn-danger btn-sm" Onclick="return confirm('Yakin Ingin Menghapus?')"><i class="fa fa-trash"></i>&nbsp; Hapus</button></a>
                        </td>
                      </tr>
                    <?php } ?>
                    </tbody>
